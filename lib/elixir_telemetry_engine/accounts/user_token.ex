defmodule ElixirTelemetryEngine.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias ElixirTelemetryEngine.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, ElixirTelemetryEngine.Accounts.User
